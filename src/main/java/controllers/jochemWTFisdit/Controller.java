package main.java.controllers.jochemWTFisdit;
...
public class Controller {
    ...
    private void gotoOverview() throws IOException {
        ...
        Parent overviewScene = FXMLLoader.load(getClass().getResource("Overview.fxml"));
    ...
    private void gotoEnterKilometers() throws IOException {
        ...
        Parent overviewScene = FXMLLoader.load(getClass().getResource("EnterKilometers.fxml"));
        stage.setScene(new Scene(overviewScene, 1200, 900));
    }
